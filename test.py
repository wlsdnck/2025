...
# --- 시화의 따뜻한 환영 메시지! ---
st.set_page_config(layout="wide", page_title="시화의 슈퍼 디테일 아이돌 가이드")

st.title("💖 넉넉한초콜릿8098님을 위한 슈퍼 디테일 아이돌 가이드! 🌟")
st.write("와! 넉넉한초콜릿8098, 그룹 정보를 더 자세하게 보여달라고?! 역시! 맘껏 덕질할 수 있게 상세 정보들을 추가해뒀어! 😆")
...
# --- 아이돌 그룹 데이터베이스 ---
# 넉넉한초콜릿8098이 요청한 그룹들만 포함 + 상세 정보 추가!
group_database = {
    "BTS (방탄소년단)": {
        ...
        "데뷔일": "2013년 6월 13일", # 상세 정보
        "소속사": "빅히트 뮤직", # 상세 정보
        "팬덤명": "아미 (ARMY)", # 상세 정보
        "응원봉_이름": "아미밤 (ARMY BOMB)", # 상세 정보
        "공식색": ["보라색 (Purple)"], # 상세 정보
        "인기곡": [
...
st.sidebar.write("예: `streamlit run my_detailed_idol_app.py`")
